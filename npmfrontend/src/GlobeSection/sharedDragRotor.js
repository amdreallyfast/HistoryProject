...
//
// Ordering is by R3F tree/mount order: MouseHandler is mounted before
// EditableRegion in Scene.jsx, so its useFrame runs first within a given RAF
// and writes the latest rotor before the mesh consumers read it. If those
// components are ever reordered, preserve this invariant (or switch to an
// explicit useFrame renderPriority).
//
...
// determining moveAllPins vs. moveThisPin. Only the per-frame rotor value
// lives here.
//
